...
@page { margin: 0; }
	...
	?>
		<header>
			<h1>Invoice</h1>
			<address >
				<p>MOON LIGHT HOTEL,</p>
				<p>Vandalur-Kelambakkam Road,<br>Chennai,<br>India.</p>
				<p>(+91) 8100 258 835</p>
			</address>
			<span><img alt="" src="assets/img/moon.png"></span>
		</header>
		<article>
			<h1>Recipient</h1>
			<address >
		...
		<aside>
			...
			<div >
				<p align="center">Email :- info@moonlight.com || Web :- www.moonlight.com || Phone :- +91 8100 258 835 </p>
			</div>
		</aside>
	</body>
</html>
